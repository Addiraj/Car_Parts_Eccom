...
function createSupabaseClient() {
  ...
  // Fall back to process.env for SSR (server-side rendering) — guarded because
  // `process` does not exist in the browser runtime and referencing it unguarded
  // throws ReferenceError instead of falling through.
  const SUPABASE_URL =
