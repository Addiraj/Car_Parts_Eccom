      ...
      <div className="mt-6 grid gap-8 lg:grid-cols-[minmax(0,1fr)_400px]">
        ...
        <div>
          ...
          <div className="mt-2 space-y-1 font-mono text-xs text-muted-foreground">
            <div>{t("partNumber")}: <span className="text-foreground">{part.part_number}</span></div>
          ...
          <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
            {alternatives.map((a: any) => a.part && (
              <Link key={a.alternative_part_id} to="/parts/$id" params={{ id: a.part.id }}
                ...
                <div className="p-3">
                  <div className="font-mono text-[10px] text-muted-foreground">{a.part.part_number}</div>
